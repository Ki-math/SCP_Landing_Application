...
if isfield(prob,'suicideBurn') && ~isfield(prm,'suicideBurn'), prm.suicideBurn = prob.suicideBurn; end
if isfield(prob,'suicideMargin') && ~isfield(prm,'suicideMargin'), prm.suicideMargin = prob.suicideMargin; end
if isfield(prob,'suicideVtd') && ~isfield(prm,'suicideVtd'), prm.suicideVtd = prob.suicideVtd; end
if isfield(prob,'suicideNomEff') && ~isfield(prm,'suicideNomEff'), prm.suicideNomEff = prob.suicideNomEff; end
if isfield(prob,'suicideRefBlend') && ~isfield(prm,'suicideRefBlend'), prm.suicideRefBlend = prob.suicideRefBlend; end
if isfield(prob,'suicideVelBlend') && ~isfield(prm,'suicideVelBlend'), prm.suicideVelBlend = prob.suicideVelBlend; end
if isfield(prob,'suicideAdvanceMax') && ~isfield(prm,'suicideAdvanceMax'), prm.suicideAdvanceMax = prob.suicideAdvanceMax; end
if isfield(prob,'wnAtt') && ~isfield(prm,'wnAtt'), prm.wnAtt = prob.wnAtt; end
if isfield(prob,'ztAtt') && ~isfield(prm,'ztAtt'), prm.ztAtt = prob.ztAtt; end
