...
prmT = struct('planFile',A.planFile, 'errTrig',inf, 'windY',0, 'thrEff',0.97, ...
    ...
    'suicideBurn',A.ctl.suicideBurn, 'suicideMargin',A.ctl.suicideMargin, ...
    'suicideVtd',A.ctl.suicideVtd, 'suicideNomEff',A.ctl.suicideNomEff, ...
    'suicideRefBlend',A.ctl.suicideRefBlend, 'suicideVelBlend',A.ctl.suicideVelBlend, ...
    'suicideAdvanceMax',A.ctl.suicideAdvanceMax, ...
